...
#if !defined(_CHIBIOS_HAL_CONF_VER_6_0_)
#error "obsolete or unknown HAL configuration file"
#else
// #warning "ChibiOS HAL 6.0 configuration file found, this is compatible but update to 7.0 is recommended"
#endif
#endif
